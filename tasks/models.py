...
class Task(models.Model):
    ...
    poster = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="tasks_posted"
    )
    asignee = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="tasks_assigned", null=True
    )
    ...
    def get_absolute_url(self):
        return reverse("tasks:task_detail", args=[self.pk, self.slug])
